  ...
  const profile: ExportColumnDef<Application>[] = [
    {
      id: "applicationCode",
      label: "Mã hồ sơ",
      getValue: (r) => r.applicationCode ?? r.id,
      defaultSelected: true,
      serverKey: { type: "profile", key: "applicationCode" },
    },
    {
      id: "fullName",
      label: "Họ và tên",
    ...
    },
    {
      id: "className",
      label: "Lớp",
      getValue: (r) => r.className ?? r.education ?? "",
      defaultSelected: true,
    ...
    },
    {
      id: "dateOfBirth",
      label: "Ngày sinh",
      getValue: (r) => (r.dateOfBirth ? formatDate(r.dateOfBirth) : ""),
      defaultSelected: true,
    ...
    },
    {
      ...
      label: "Ban chính thức",
      getValue: (r) => r.assignedDepartment ?? "",
      defaultSelected: true,
      serverKey: { type: "profile", key: "assignedDepartment" },
    },
    {
      id: "campaign",
      label: "Đợt tuyển",
      ...
      <ExportDataModal
        ...
        exporter={async ({ columns, rows }) => {
          ...
          const targetRows = selectedIds.size > 0
            ...
            : rows;
          const applicationIds = targetRows.map((r) => r.id);
          try {
