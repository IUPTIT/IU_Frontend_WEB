...
function ReviewBanner({ review, onAction }: { review: PendingReview; onAction: () => void }) {
  return (
    <article className="ui-card flex flex-col sm:flex-row items-start sm:items-center gap-6 p-6 sm:p-8">
      <div className="ui-well h-14 w-14 rounded-full shrink-0 text-accent">
      ...
      <button className="ui-btn-primary shrink-0" onClick={onAction}>
        Đánh giá ngay
      </button>
    </article>
  );
