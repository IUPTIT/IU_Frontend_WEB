...
function CandidateTrainingPage() {
    ...
    return (
      <section className="neu-card !p-8 text-center">
        <p className="text-muted">
          Bạn chưa vào vòng training. Vòng training mở sau khi bạn đạt phỏng
          vấn.
        </p>
      </section>
    );
  ...
  const { trainee, group, program } = training;
          ...
          <section className="neu-card !p-6 space-y-4">
            ...
            {group ? (
              <>
                ...
                <p className="text-xs text-muted">
                  Thành viên trong team: {group.memberIds.length}
                </p>
              </>
            ) : (
              <p className="text-sm text-muted">
                Chưa được chia team — chờ BCN chia đội.
              </p>
            )}
          </section>
        ...
        <section className="space-y-4">
          ...
          {tasks.length === 0 ? (
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              {tasks.map((t) => (
                <TaskCard key={t.id} task={t} onSubmitted={reload} />
              ))}
            </div>
          )}
        </section>
